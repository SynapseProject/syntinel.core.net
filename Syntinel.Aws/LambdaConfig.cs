...
namespace Syntinel.Aws
{
    public class LambdaConfig
    {
        ...
        public LambdaConfig()
        {
            ...
            ProcessCueLambda = GetVariable("Syntinel_ProcessCueFunctionName", "syntinel-process-cue");
            ProcessSignalLambda = GetVariable("Syntinel_ProcessSignalFunctionName", "syntinel-process-signal");
            ProcessStatusLambda = GetVariable("Syntinel_ProcessStatusFunctionName", "syntinel-process-status");
        }
